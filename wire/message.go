...
func (me *MessageEncoder) EncodeMessage(data interface{}, msg *schema.Message) error {
	...
	if msg.IsWrapper {
		...
		if field == nil {
			return newFieldError("missing union field in %s", msg.Name)
		}
		...
		if !ok {
			return newFieldError("message value for field %s must be map[string]interface{}, got %T", msg.Name, data)
		}
	}
	...
	for _, entry := range entries {
		...
		if field.Type.Kind == schema.KindMap {
			if err := me.encodeMapField(messageEncoder, fieldValue, field); err != nil {
				return wrapEncodingFieldError(err, fieldName)
			}
			continue
		}
...
func (me *MessageEncoder) encodeFieldValue(encoder *Encoder, value interface{}, field *schema.Field) error {
	...
	default:
		return newFieldError("unsupported field type: %s", field.Type.Kind)
	}
}
...
func (me *MessageEncoder) encodeRepeatedField(encoder *Encoder, value interface{}, field *schema.Field) error {
	...
	if !ok {
		...
		default:
			return newFieldError("repeated field value must be a slice, got %T", value)
		}
	}
	if field.JSONString {
	...
	for i, element := range slice {
		...
		default:
			return newFieldError("unsupported repeated field type: %s", field.Type.Kind)
		}
	}
...
func (me *MessageEncoder) encodePrimitiveField(encoder *Encoder, value interface{}, primitiveType schema.PrimitiveType) error {
	...
	case schema.TypeString:
		v, ok := value.(string)
		if !ok {
			return newFieldError("expected string, got %T", value)
		}
	...
	case schema.TypeBytes:
		v, ok := value.([]byte)
		if !ok {
			return newFieldError("expected []byte, got %T", value)
		}
	...
	case schema.TypeInt64:
		...
		if !ok {
			...
			if !ok {
				return newFieldError("expected int64, got %T", value)
			}
	...
	case schema.TypeUint32:
		...
		if !ok {
			jsonVal, ok := value.(json.Number)
			if !ok {
				return newFieldError("expected uint32, got %T", value)
			}
	...
	case schema.TypeUint64:
		...
		if !ok {
			jsonVal, ok := value.(json.Number)
			if !ok {
				return newFieldError("expected uint64, got %T", value)
			}
	...
	case schema.TypeBool:
		v, ok := value.(bool)
		if !ok {
			return newFieldError("expected bool, got %T", value)
		}
	...
	case schema.TypeFloat:
		...
		if !ok {
			jsonVal, ok := value.(json.Number)
			if !ok {
				return newFieldError("expected float32, got %T", value)
			}
	...
	case schema.TypeDouble:
		...
		if !ok {
			jsonVal, ok := value.(json.Number)
			if !ok {
				return newFieldError("expected float64, got %T", value)
			}
	...
	case schema.TypeSfixed32:
		...
		if !ok {
			jsonVal, ok := value.(json.Number)
			if !ok {
				return newFieldError("expected int32, got %T", value)
			}
	...
	case schema.TypeSint64:
		...
		return NewFixedEncoder(encoder).EncodeSfixed64(v)
	default:
		return newFieldError("unsupported primitive type: %s", primitiveType)
	}
}
...
func (me *MessageEncoder) encodeMessageField(encoder *Encoder, value interface{}, messageTypeName string) error {
	...
	if me.encoder.registry == nil {
		return newFieldError("registry is required to encode message fields")
	}

	messageSchema, err := me.encoder.registry.GetMessage(messageTypeName)
	if err != nil {
		return newFieldError("failed to get message schema for %s: %v", messageTypeName, err)
	}
...
func (me *MessageEncoder) encodeEnumField(encoder *Encoder, value interface{}, fieldType schema.FieldType) error {
	...
	if !ok {
		...
		if !isJsonNumber {
			return newFieldError("enum value must be string for %s field", fieldType.EnumType)
		}
		enumValue = enumValueInJsonNumber.String()
	}
	enum, err := me.encoder.registry.GetEnum(fieldType.EnumType)
	if err != nil {
		return newFieldError("unknown enum %s received for enum, with value %v", fieldType.EnumType, value)
	}
	...
	return newFieldError("cannot find field value %s in the enum %v", enumValue, enum.Values)
...
func (me *MessageEncoder) encodeWrapperField(encoder *Encoder, value interface{}, wrapperType schema.WrapperType) error {
	...
	extractWrapperValue := func(v interface{}) (interface{}, error) {
		...
		if mapVal, ok := v.(map[string]interface{}); ok {
			...
			return nil, newFieldError("wrapper map must contain 'value' field")
		}
		return v, nil
	}
	...
	case schema.WrapperDoubleValue:
		...
		case json.Number:
			val, err = v.Float64()
			if err != nil {
				return newFieldError("invalid float64: %v", err)
			}
		default:
			return newFieldError("unexpected type for float64: %T", actualValue)
		}
	...
	case schema.WrapperFloatValue:
		...
		case json.Number:
			...
			if err != nil {
				return newFieldError("invalid float32: %v", err)
			}
			val = float32(f64)
		default:
			return newFieldError("unexpected type for float32: %T", actualValue)
		}
	...
	case schema.WrapperInt64Value:
		...
		case json.Number:
			val, err = v.Int64()
			if err != nil {
				return newFieldError("invalid int64: %v", err)
			}
		default:
			return newFieldError("unexpected type for int64: %T", actualValue)
		}
	...
	case schema.WrapperUInt64Value:
		...
		case json.Number:
			...
			if err != nil {
				return newFieldError("invalid uint64: %v", err)
			}
		default:
			return newFieldError("unexpected type for uint64: %T", actualValue)
		}
		tag := MakeTag(FieldNumber(1), WireVarint)
		ve.EncodeVarint(uint64(tag))
		ve.EncodeUint64(val)
	...
	case schema.WrapperUInt32Value:
		...
		case json.Number:
			...
			if err != nil {
				return newFieldError("invalid uint32: %v", err)
			}
			val = uint32(u64)
		default:
			return newFieldError("unexpected type for uint32: %T", actualValue)
		}
		tag := MakeTag(FieldNumber(1), WireVarint)
		ve.EncodeVarint(uint64(tag))
		ve.EncodeUint32(val)
	...
	case schema.WrapperBoolValue:
		...
		if !ok {
			return newFieldError("unexpected type for bool: %T", actualValue)
		}
		tag := MakeTag(FieldNumber(1), WireVarint)
		ve.EncodeVarint(uint64(tag))
		ve.EncodeBool(val)
	...
	case schema.WrapperStringValue:
		...
		if !ok {
			return newFieldError("unexpected type for string: %T", actualValue)
		}
	...
	case schema.WrapperBytesValue:
		...
		if !ok {
			return newFieldError("unexpected type for bytes: %T", actualValue)
		}
		tag := MakeTag(FieldNumber(1), WireBytes)
		ve.EncodeVarint(uint64(tag))
		be := NewBytesEncoder(wrapperEncoder)
	...
	default:
		return newFieldError("unsupported wrapper type: %s", wrapperType)
	}
...
func convertToInt32(value interface{}) (int32, error) {
	...
	case int64:
		if v < math.MinInt32 || v > math.MaxInt32 {
			return 0, newFieldError("value %d out of int32 range", v)
		}
		return int32(v), nil
	case json.Number:
		i64, err := v.Int64()
		if err != nil {
			return 0, newFieldError("invalid int32: %v", err)
		}
		if i64 < math.MinInt32 || i64 > math.MaxInt32 {
			return 0, newFieldError("value %d out of int32 range", i64)
		}
		return int32(i64), nil
	default:
		return 0, newFieldError("unexpected type for int32: %T", value)
	}
}
...
func (me *MessageEncoder) encodeMapField(encoder *Encoder, value interface{}, field *schema.Field) error {
		...
		for k, val := range v {
			...
			if field.Type.MapValue.Kind == schema.KindMessage {
				if messageData, ok := val.(map[string]interface{}); ok {
					...
					if err != nil {
						return newFieldError("failed to get message schema for %s: %v", field.Type.MapValue.MessageType, err)
					}
	...
	default:
		return newFieldError("unsupported map type: %T", value)
	}
